...
class MainMenu{
    ...
    actionOnClick(){
        var downTween: Phaser.Tween = this.game.add.tween(this.snowman).to({y: this.game.world.height + 100}, 800, Phaser.Easing.Cubic.In, true);
        var self = this;
    ...
    showText(){
        var bar: Phaser.Graphics = this.game.add.graphics();
